...
inline static bool KeyJustReleased(GameControllerButton key, int padNum) { return geGamepadButtonJustReleased(padNum, (int)key); }
inline static bool KeyJustReleased(KeyboardKeys key, GameControllerButton button, int padNum) { return KeyJustReleased(key) || KeyJustReleased(button, padNum); }
inline static bool KeyJustPressed(KeyboardKeys key) { return geKeyJustPressed((int)key); }
inline static bool KeyJustPressed(GameControllerButton key, int padNum) { return geGamepadButtonJustPressed(padNum, (int)key); }
inline static bool KeyJustPressed(KeyboardKeys key, GameControllerButton button, int padNum) { return KeyJustPressed(key) || KeyJustPressed(button, padNum); }
inline static bool KeyHeldDown(KeyboardKeys key) { return geKeyHeldDown((int)key); }
inline static bool KeyHeldDown(GameControllerButton key, int padNum) { return geGamepadButtonHeldDown(padNum, (int)key); }
inline static bool KeyHeldDown(KeyboardKeys key, GameControllerButton button, int padNum) { return KeyHeldDown(key) || KeyHeldDown(button, padNum); }
inline static bool KeyDown(KeyboardKeys key) { return geKeyHeldDown((int)key) || geKeyJustPressed((int)key); }
inline static bool KeyDown(GameControllerButton key, int padNum) { return geGamepadButtonJustPressed(padNum, (int)key) || geGamepadButtonHeldDown(padNum, (int)key); }
